...
import { useLoaderData, useActionData, Form, redirect, useNavigate } from "react-router";
  ...
  try {
    switch (actionType) {
      case "updateName": {
        ...
        await updateUser(token, { name, company });
        return { success: true, message: "Profile updated successfully!", type: "updateName" };
      }
