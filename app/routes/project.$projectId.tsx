...
import { useLoaderData, Link, Form, useActionData, useNavigate } from "react-router";
...
import { ArrowLeft, Copy, Users, Key, Settings, Activity, CheckCircle, AlertCircle, Trash2, Pencil } from "lucide-react";
...
export default function ProjectDetail() {
  ...
  const [activeTab, setActiveTab] = useState<"overview" | "apikeys" | "team" | "settings">("overview");
